...
const OntarioCriticalAlert$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioCriticalAlert extends H {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
...
function defineCustomElement$1() {
	...
	const components = ['ontario-critical-alert'];
	components.forEach((tagName) => {
		switch (tagName) {
			case 'ontario-critical-alert':
				if (!customElements.get(tagName)) {
					customElements.define(tagName, OntarioCriticalAlert$1);
				}
				break;
		}
	});
...
const OntarioCriticalAlert = OntarioCriticalAlert$1;
const defineCustomElement = defineCustomElement$1;

export { OntarioCriticalAlert, defineCustomElement };
