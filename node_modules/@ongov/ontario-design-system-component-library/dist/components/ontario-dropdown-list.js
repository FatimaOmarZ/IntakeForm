...
import { b as validateLanguage, a as validatePropExists, c as validateObjectExists } from './p-CNqFEifG.js';
import { C as ConsoleMessageClass } from './p-CJXRCL8b.js';
import { h as hasMultipleTrueValues } from './p-DQi-JVyL.js';
...
const OntarioDropdownList$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioDropdownList extends H {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
