...
const OntarioIconInteracEnAlt$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconInteracEnAlt extends H {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
			...
			return h(
				...
				h(
					...
					h(
						...
						h('use', { key: '8d536f88ad660f81a4420c6de0a672fa270b11e5', href: '#B' }),
						h('path', {
						...
						h('use', { key: '7287eb8b829e13774c4c2b7d3ac60eef0bca2d4c', href: '#B', x: '3.748' }),
						h('path', {
