...
const OntarioIconInteracFrAlt$1 = /*@__PURE__*/ proxyCustomElement(
	class OntarioIconInteracFrAlt extends H {
		constructor() {
			super();
			this.__registerHost();
			this.__attachShadow();
			...
			return h(
				...
				h(
					...
					h(
						...
						h('use', { key: '13bebd6c9719a9486e6ae1ec2f6ed8ed851400b1', href: '#B2' }),
						h('path', {
						...
						h('use', { key: '17437207fcd4d14e5afffc7b5cd1d063c1654842', href: '#B2', y: '2.036' }),
						h('path', {
