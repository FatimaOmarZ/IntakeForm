...
var index$1 = require('./index-N4QX3Rgg.js');
var consoleMessage = require('./console-message-B2SEf-GP.js');
...
const OntarioAccordion = class {
	...
	render() {
		return index.h(
			...
			index.h('h2', { key: 'b13104816ae4a4ae5292afbc94ffb526c020babe' }, this.name),
			index.h(
				'div',
				...
				this.internalAccordionData?.map((accordion, index$1) =>
					index.h(
						'div',
						{
						...
						index.h(
							'h3',
							{
								class: `ontario-accordion__heading ${this.openAccordionIndexes.includes(index$1) ? 'ontario-expander--active' : ''}`,
							},
							index.h(
								'button',
								{
...
OntarioAccordion.style = ontarioAccordionCss;
...
const generateCalloutAside = (type, headingContentType, headingType, headingContent, content, highlightColour) => {
	...
	return type === 'callout'
		...
		: index.h(
				...
				{ class: generateClasses(type, highlightColour) },
				headingContent ? generateHeading(type, headingType, headingContentType, headingContent) : '',
				contentIsString ? (content ? index.h('p', null, content) : '') : index.h('slot', null),
			);
};
...
const OntarioBadge = class {
	...
	validateColour() {
		if (this.colour) {
			if (index$1.validateValueAgainstArray(this.colour, BadgeColours)) {
				return this.colour;
			} else {
				const message = new consoleMessage.ConsoleMessageClass();
				message
...
OntarioBadge.style = ontarioBadgeCss;
...
const OntarioBlockquote = class {
	...
	render() {
		return index.h(
			...
			index.h('p', { key: 'edda8b3587f2eab9c8e06ee3fbc4162e980cc4a2' }, this.quoteState),
			this.attribution &&
				index.h(
					'cite',
...
const OntarioCard = class {
	...
	validateLayoutDirection() {
		const isValid =
			this.layoutDirection && index$1.validateValueAgainstArray(this.layoutDirection, layoutDirectionDefinitions);
		if (!isValid) {
	...
	validateHeadingLevel() {
		const isValid = this.headingLevel && index$1.validateValueAgainstArray(this.headingLevel, headingLevelDefinitions);
		if (!isValid) {
	...
	validateHeaderColour() {
		const isValid = this.headerColour && index$1.validateValueAgainstArray(this.headerColour, headerColourDefinitions);
		...
		return index.h(
			...
			index.h(
				...
				index.h(
					...
					index.h('a', { 'href': this.getHref(), 'aria-label': this.ariaLabelText }, this.label),
				),
				this.description &&
					index.h(
						'div',
						{ key: 'f7dad07c4e39806379e3cdbd63d4edcc913859f9', class: 'ontario-card__description' },
						index.h('p', { key: 'ae429b791a870a174ad39610fd12d426fdb382cd' }, this.description),
					),
			),
		);
	}
...
OntarioCard.style = ontarioCardCss;
...
const OntarioCardCollection = class {
	...
	render() {
		return index.h(
			...
			index.h('slot', { key: 'f75f012338edd1a94ed1c5b3d197a9b909b36250' }),
		);
	}
	static get watchers() {
		return {
...
OntarioCardCollection.style = ontarioCardCollectionCss;
...
const OntarioCheckboxes = class {
	constructor(hostRef) {
		index.registerInstance(this, hostRef);
		this.checkboxOnChange = index.createEvent(this, 'checkboxOnChange');
		this.checkboxOnBlur = index.createEvent(this, 'checkboxOnBlur');
		this.checkboxOnFocus = index.createEvent(this, 'checkboxOnFocus');
		this.inputErrorOccurred = index.createEvent(this, 'inputErrorOccurred');
		if (hostRef.$hostElement$['s-ei']) {
			this.internals = hostRef.$hostElement$['s-ei'];
		} else {
			this.internals = hostRef.$hostElement$.attachInternals();
...
var OntarioIconCriticalAlertWarning = `<svg class="svg-icon" role="img" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			index.h(
				...
				index.h(
					...
					index.h(
						...
						index.h('p', { key: '52ac104930699c9a5ae80bd982312048426455b4' }, this.renderContent()),
					),
				),
			),
		);
...
const OntarioDateInput = class {
	constructor(hostRef) {
		index.registerInstance(this, hostRef);
		this.inputOnInput = index.createEvent(this, 'inputOnInput');
		this.inputOnChange = index.createEvent(this, 'inputOnChange');
		this.inputOnBlur = index.createEvent(this, 'inputOnBlur');
		this.inputOnFocus = index.createEvent(this, 'inputOnFocus');
		this.inputErrorOccurred = index.createEvent(this, 'inputErrorOccurred');
		if (hostRef.$hostElement$['s-ei']) {
			this.internals = hostRef.$hostElement$['s-ei'];
		} else {
...
OntarioDateInput.style = ontarioDateInputCss;
 ...
 */
function getImageAssetSrcPath(imageName, assetBasePath) {
	if (assetBasePath) {
		return `${assetBasePath.replace(/\/$/, '')}/${imageName}`;
	}
	try {
		return index.getAssetPath(`./assets/${imageName}`);
	} catch (error) {
...
const OntarioDropdownList = class {
	constructor(hostRef) {
		index.registerInstance(this, hostRef);
		this.dropdownOnChange = index.createEvent(this, 'dropdownOnChange');
		this.dropdownOnBlur = index.createEvent(this, 'dropdownOnBlur');
		this.dropdownOnFocus = index.createEvent(this, 'dropdownOnFocus');
		this.inputErrorOccurred = index.createEvent(this, 'inputErrorOccurred');
		if (hostRef.$hostElement$['s-ei']) {
			this.internals = hostRef.$hostElement$['s-ei'];
		} else {
	...
	render() {
		...
		return index.h(
			...
			index.h(ErrorMessage, {
				key: '0f8e2e970e004e10c920df7716ea394902352012',
				message: this.errorMessage,
				error: error,
			}),
			index.h(
	...
	render() {
		return index.h(
			...
			index.h(
				...
				index.h('slot', { key: 'e6835d747a0a988fe1d890875af812ed66f86434' }),
			),
		);
	}
	static get watchers() {
			...
			index.h(
				...
				contactLink &&
					index.h(
						'li',
						null,
						index.h('a', { class: 'ontario-footer__link', href: contactLink?.href }, contactLink?.text),
					),
				termsOfUseLink &&
					index.h(
						'li',
						null,
						index.h('a', { class: 'ontario-footer__link', href: termsOfUseLink?.href }, termsOfUseLink?.text),
					),
			),
			index.h(
				'div',
...
const FooterColumn = ({ data, socialLinks, isThreeColLayout = false, isFullWidthInMediumLayout = false }) => {
	...
	return index.h(
		...
		socialLinks && index.h(FooterSocialLinks, { ...socialLinks }),
	);
};
...
const ExpandedFooterWrapper = (props, children) => {
	...
	return index.h(
		...
		index.h(SimpleFooter, { ...footerLinks, className: 'ontario-footer__expanded-bottom-section' }),
	);
};
...
const OntarioFooter = class {
	...
	render() {
		...
		return index.h(
			...
			index.h(SimpleFooter, { ...footerLinks }),
		);
	}
	static get assetsDirs() {
		return ['assets'];
...
OntarioHeader.style = ontarioHeaderCss + (ontarioApplicationHeaderCss + serviceOntarioHeaderCss);
...
const OntarioHintExpander = class {
	constructor(hostRef) {
		index.registerInstance(this, hostRef);
		this.toggleExpanderEvent = index.createEvent(this, 'toggleExpanderEvent');
	}
	get host() {
		return index.getElement(this);
	}
		...
		return index.h(
			...
			index.h(
				...
				index.h(
					...
					index.h('ontario-icon-chevron-up', { key: '6aa07816393bc8768e0304b58c66226e7502ca8a', colour: 'inherit' }),
				),
				index.h(
					'span',
					{ key: '5bfe9d549dfcce83d26ec351856d3cc1c1f4d9c2', class: 'ontario-hint-expander__button-icon--open' },
					index.h('ontario-icon-chevron-down', { key: '24650b2b0254fe5429cb43195d93f2b3a653b168', colour: 'inherit' }),
				),
				this.hint,
			),
			index.h(
...
const OntarioHintText = class {
	...
	render() {
		return this.hintContentType === 'string'
			? index.h('p', { part: 'hint-text', id: this.getId(), class: 'ontario-hint' }, this.hintState)
...
const OntarioLanguageToggle = class {
	constructor(hostRef) {
		index.registerInstance(this, hostRef);
		this.setAppLanguage = index.createEvent(this, 'setAppLanguage');
		this.headerLanguageToggled = index.createEvent(this, 'headerLanguageToggled');
	}
	/**
	 * The language of the component.
	 *
	...
	render() {
		return index.h(
			...
			this.size === 'small'
				? index.h('span', null, this.oppositeLanguageLabel?.fullWord)
				: index.h(
						index.Fragment,
						null,
						index.h(
						...
						index.h('span', { class: 'ontario-show-for-medium' }, this.oppositeLanguageLabel?.fullWord),
					),
		);
	}
	static get watchers() {
		...
		return this.typeState === 'large'
			? index.h(
					...
					index.h(
						...
						index.h('p', null, this.message ?? this.translations.loading[`${this.language}`]),
					),
				)
...
const OntarioPageAlert = class {
	...
	renderIcon() {
		...
		switch (this.type) {
			case 'informational':
				return index.h('ontario-icon-alert-information', { ...iconProps });
			case 'success':
				return index.h('ontario-icon-alert-success', { ...iconProps });
			case 'warning':
				return index.h('ontario-icon-alert-warning', { ...iconProps });
			case 'error':
				return index.h('ontario-icon-alert-error', { ...iconProps });
		}
	}
	renderContent() {
...
const OntarioRadioButtons = class {
	constructor(hostRef) {
		index.registerInstance(this, hostRef);
		this.radioOnChange = index.createEvent(this, 'radioOnChange');
		this.radioOnBlur = index.createEvent(this, 'radioOnBlur');
		this.radioOnFocus = index.createEvent(this, 'radioOnFocus');
		this.inputErrorOccurred = index.createEvent(this, 'inputErrorOccurred');
		if (hostRef.$hostElement$['s-ei']) {
			this.internals = hostRef.$hostElement$['s-ei'];
		} else {
...
const OntarioSearchBox = class {
	constructor(hostRef) {
		index.registerInstance(this, hostRef);
		this.searchOnSubmit = index.createEvent(this, 'searchOnSubmit');
		this.inputOnInput = index.createEvent(this, 'inputOnInput');
		this.inputOnChange = index.createEvent(this, 'inputOnChange');
		this.inputOnBlur = index.createEvent(this, 'inputOnBlur');
		this.inputOnFocus = index.createEvent(this, 'inputOnFocus');
		...
		return index.h(
			...
			index.h(
				...
				index.h(
					...
					index.h('span', { key: '9e8068e22e63dae3f6cafbfcaaccbbc466976121', innerHTML: OntarioIconSearch }),
				),
			),
		);
	}
...
OntarioSearchBox.style = ontarioSearchBoxCss;
		...
		return index.h(
			...
			index.h(
				...
				index.h(
					...
					index.h(
						...
						this.showBackButton === true &&
							...
							index.h(
								...
								index.h('ontario-icon-chevron-left', {
					...
					index.h('hr', { key: '50951805695a30af40d20f7500f8dc8ede620f71' }),
				),
			),
		);
	}
		...
		return index.h(
			...
			index.h(
				...
				index.h(
					...
					this.caption && index.h('caption', { key: 'aa662bd73b1b2315642e624e31e288ea096f583c' }, this.caption),
...
OntarioTable.style = ontarioTableCss;
...
const OntarioTask = class {
	...
	validateHeadingLevel(newValue) {
		...
		const isValid = index$1.validateValueAgainstArray(newValue, allowedValues);
		if (!isValid) {
			const message = new consoleMessage.ConsoleMessageClass();
			message
				.addDesignSystemTag()
	...
	getTranslatedTaskStatus() {
		const resolvedLanguage = index$1.validateLanguage(this.language);
	...
	renderHintText() {
		if (this.internalHintText) {
			return index.h('ontario-hint-text', {
				hint: this.internalHintText.hint,
				hintContentType: this.internalHintText.hintContentType,
				ref: (el) => (this.hintTextRef = el),
			});
	...
	renderTaskContent() {
		...
		return index.h(
			...
			index.h(this.headingLevel, headingProps, this.label),
			this.taskStatusState &&
				index.h(
					'ontario-badge',
					{
						...
						'role': 'status',
						'aria-label': `${translations.taskStatus.taskStatus[index$1.validateLanguage(this.language)]} ${this.getTranslatedTaskStatus()} (${this.taskStatusState})`,
	...
	render() {
		...
		return index.h(
			...
			isLinkActive
				? index.h('a', { 'href': this.link, 'class': 'ontario-task__link', 'aria-label': this.label }, taskContent)
				: index.h('div', null, taskContent),
		);
	}
	static get watchers() {
		return {
...
OntarioTask.style = ontarioTaskCss;
	...
	render() {
		...
		return index.h(
			...
			index.h(
				...
				index.h('slot', { key: 'd226bd26241b20557f13a0acdb161ae474c915e1' }),
			),
		);
	}
	static get watchers() {
...
OntarioTaskList.style = ontarioTaskListCss;
...
exports.ontario_badge = OntarioBadge;
...
exports.ontario_search_box = OntarioSearchBox;
exports.ontario_step_indicator = OntarioStepIndicator;
exports.ontario_table = OntarioTable;
exports.ontario_task = OntarioTask;
exports.ontario_task_list = OntarioTaskList;
exports.ontario_textarea = OntarioTextarea;
//# sourceMappingURL=ontario-accordion.ontario-aside.ontario-back-to-top.ontario-badge.ontario-blockquote.ontario-button.ontario-callout.ontario-card.ontario-card-collection.ontario-checkboxes.ontario-critical-alert.ontario-date-input.ontario-dropdown-list.ontario-fieldset.ontario-footer.ontario-header.ontario-hint-expander.ontario-hint-text.ontario-icon-accessibility.ontario-icon-alert-error.ontario-icon-alert-information.ontario-icon-alert-success.ontario-icon-alert-warning.ontario-icon-camera.ontario-icon-chevron-down.ontario-icon-chevron-left.ontario-icon-chevron-up.ontario-icon-email.ontario-icon-help.ontario-icon-mastercard.ontario-icon-notification.ontario-icon-print.ontario-icon-sentiment-5.ontario-icon-text-message.ontario-icon-transport-bus.ontario-input.ontario-language-toggle.ontario-loading-indicator.ontario-page-alert.ontario-radio-buttons.ontario-search-box.ontario-step-indicator.ontario-table.ontario-task.ontario-task-list.ontario-textarea.entry.cjs.js.map

//# sourceMappingURL=ontario-accordion_46.cjs.entry.js.map
