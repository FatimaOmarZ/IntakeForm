import {
	...
	d as getAssetPath,
	F as Fragment,
} from './index-Cc98g_3o.js';
import {
	b as validateLanguage,
	v as validateValueAgainstArray,
	c as validatePropExists,
	d as validateObjectExists,
	a as validateColor,
	I as IconColours,
} from './index-_eQ6Jzc4.js';
import { C as ConsoleMessageClass, a as ConsoleType } from './console-message-CJXRCL8b.js';
...
const generateCalloutAside = (type, headingContentType, headingType, headingContent, content, highlightColour) => {
	...
	return type === 'callout'
		...
		: h(
				...
				{ class: generateClasses(type, highlightColour) },
				headingContent ? generateHeading(type, headingType, headingContentType, headingContent) : '',
				contentIsString ? (content ? h('p', null, content) : '') : h('slot', null),
			);
};
	...
	render() {
		...
		return h(
			...
			h(
				...
				h(ErrorMessage, { key: 'c775a4a1ec00311fcb831473e9b6a51add3cb569', message: this.errorMessage, error: error }),
				h(
					'div',
			...
			h(
				...
				h(
					...
					h(
						...
						h('p', { key: '52ac104930699c9a5ae80bd982312048426455b4' }, this.renderContent()),
					),
				),
			),
		);
	...
	render() {
		...
		return h(
			...
			h(
				...
				!!hintText &&
					h('p', { key: '9bfa87affb330cbecb03b8126fd11d1168841e7c', id: hintTextId, class: 'ontario-hint' }, hintText),
				h(ErrorMessage, {
	...
	return h(
		...
		h(
			...
			h(
				...
				contactLink &&
					h('li', null, h('a', { class: 'ontario-footer__link', href: contactLink?.href }, contactLink?.text)),
				termsOfUseLink &&
					h('li', null, h('a', { class: 'ontario-footer__link', href: termsOfUseLink?.href }, termsOfUseLink?.text)),
			),
			h(
				'div',
...
const FooterColumn = ({ data, socialLinks, isThreeColLayout = false, isFullWidthInMediumLayout = false }) => {
	...
	return h(
		...
		socialLinks && h(FooterSocialLinks, { ...socialLinks }),
	);
};
...
const ExpandedFooterWrapper = (props, children) => {
	...
	return h(
		...
		h(SimpleFooter, { ...footerLinks, className: 'ontario-footer__expanded-bottom-section' }),
	);
};
								...
								h(
									...
									!isServiceOntarioType
										? h(
												...
												h('a', { href: this.applicationHeaderInfoState?.href }, this.applicationHeaderInfoState?.title),
											)
										: h(
												'a',
	...
	render() {
		return h(
			...
			h(
				...
				h('path', { key: '307169b7a8f7ad94c6c7c838cddccd2d3df2dd90', d: 'M11 10h2v4h-2zm0 6h2v2h-2z', fill: '#000' }),
			),
		);
	}
	static get watchers() {
	...
	render() {
		return h(
			...
			h(
				...
				h('circle', { key: '30806a800c500c8ff4a70bba51a75f016adb32ed', cx: '8', cy: '12', r: '6.5', fill: '#eb001b' }),
				h('circle', { key: '2b9826d666dc6e14ff1005d32c7d1a34123d5887', cx: '16', cy: '12', r: '6.5', fill: '#f79e1b' }),
				h('path', {
...
const OntarioInput = class {
	...
	render() {
		...
		return h(
			...
			h(ErrorMessage, { key: 'dd096e7cfe445817532bc7c0cf681048f417c390', message: this.errorMessage, error: error }),
			h(Input$1, {
		...
		return this.typeState === 'large'
			? h(
					...
					h(
						...
						h('p', null, this.message ?? this.translations.loading[`${this.language}`]),
					),
				)
...
const OntarioPageAlert = class {
	...
	renderIcon() {
		...
		switch (this.type) {
			case 'informational':
				return h('ontario-icon-alert-information', { ...iconProps });
			case 'success':
				return h('ontario-icon-alert-success', { ...iconProps });
			case 'warning':
				return h('ontario-icon-alert-warning', { ...iconProps });
			case 'error':
				return h('ontario-icon-alert-error', { ...iconProps });
		}
	}
	renderContent() {
	...
	render() {
		return h(
			...
			h('div', { key: 'c72fdccf42f2669259856c58be84085152dde302', class: 'ontario-alert__body' }, this.renderContent()),
		);
	}
};
...
const OntarioTextarea = class {
	...
	render() {
		...
		return h(
			...
			h(ErrorMessage, { key: 'd908a60fc99c09936564cb8d1f6652d2476f6e70', message: this.errorMessage, error: error }),
			h('textarea', {
